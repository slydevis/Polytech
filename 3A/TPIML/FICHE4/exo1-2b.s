...
#-----------------------------------------------------------------
	...
	.ktext  # Le programme sera rangé dans la partie
                # code du noyau (après le traitant des
                # exceptions, rangé à l'adresse 0x80000080)
	.globl __start
__start:
...
main:
	...
	move $s0, $0	
saisie:
        #jal getcharp # remplacée par les 2 instructions ci-dessous
	la $t0, getcharp
	jalr $t0
...
fin_saisie: 
	...
	la $a0, chaine_lu
	#jal printp # remplacée par les 2 instructions ci-dessous
	la $t0, printp
	jalr $t0
